...
class CitiesAdapter(private val onClick: (City) -> Unit) : RecyclerView.Adapter<CitiesHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CitiesHolder {
        ...
        return CitiesHolder(view, onClick)
    }
...
class CitiesHolder(itemView: View, private val onClick: (City) -> Unit) : RecyclerView.ViewHolder(itemView) {
    ...
    fun bind(city: City) {
        ...
        //occupationText.text = city.occupation ?: itemView.context.getString(R.string.occupation_absent)
